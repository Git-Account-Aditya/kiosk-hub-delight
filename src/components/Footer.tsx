      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          <div className="col-span-1">
            ...
            <p className="text-gray-600 mb-4">
              Uplifting street food vendors in India through hygiene awareness and digital inclusion.
            </p>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/hygiene-standards" className="text-gray-600 hover:text-primary">
                  Hygiene Standards
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="mt-4 space-y-2">
              ...
              <li>
                <Link to="/vendor/login" className="text-gray-600 hover:text-primary">
                  Vendor Login
                </Link>
              </li>
              <li>
                <Link to="/vendor/resources" className="text-gray-600 hover:text-primary">
                  Resources
                </Link>
              </li>
              <li>
                <Link to="/vendor/success-stories" className="text-gray-600 hover:text-primary">
                  Success Stories
                </Link>
              </li>
            </ul>
        ...
        <div className="mt-8 pt-8 border-t border-gray-200">
          <p className="text-sm text-gray-500 text-center">
            &copy; {new Date().getFullYear()} KioskHub. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
